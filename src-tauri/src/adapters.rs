...
const DEFAULT_ADAPTER_BASE: &str =
    "https://raw.githubusercontent.com/DaveTseng2019/AI-Consultant/main/adapters";
...
pub async fn open_adapter_issue(
    ...
    let mut url = tauri::Url::parse("https://github.com/DaveTseng2019/AI-Consultant/issues/new")
        .map_err(|error| error.to_string())?;
    url.query_pairs_mut()
...
mod tests {
    ...
    fn source_url_defaults_to_repo() {
        assert_eq!(
            ...
            "https://raw.githubusercontent.com/DaveTseng2019/AI-Consultant/main/adapters/chatgpt.json"
        );
    }
