// notes: AI Consultant has no release channel yet -- DaveTseng2019/AI-Consultant does not
//        exist, so the check 404s and Settings reports "releases unavailable". That is the
//        honest state; point this at a real repo once one is published.
